...
! function (e, n, t) {
  ...
  function c(e, n, i, l) {
    ...
    for (var c, p, m, y, h, v = ["modernizr", "tspan", "samp"]; !P.style && v.length;) c = !0, P.modElem = s(v.shift()), P.style = P.modElem.style;
    for (m = e.length, p = 0; p < m; p++)
      if (y = e[p], h = P.style[y], o(y, "-") && (y = d(y)), P.style[y] !== t) {
        if (l || r(i, "undefined")) return a(), "pfx" !== n || y;
        try {
          P.style[y] = i
        } catch (e) { }
        if (P.style[y] !== h) return a(), "pfx" !== n || y
      }
    return a(), !1
  }
  ...
  function m(e, n, t) {
    var o;
    for (var s in e)
      if (e[s] in n) return !1 === t ? e[s] : (o = n[e[s]], r(o, "function") ? p(o, t || n) : o);
    return !1
  }

  function y(e, n, t, o, s) {
    var i = e.charAt(0).toUpperCase() + e.slice(1),
      l = (e + " " + _.join(i + " ") + i).split(" ");
    return r(n, "string") || r(n, "undefined") ? c(l, n, o, s) : (l = (e + " " + z.join(i + " ") + i).split(" "), m(l, n, t))
  }
  ...
  var z = g._config.usePrefixes ? S.toLowerCase().split(" ") : [];
  g._domPrefixes = z, g.testAllProps = y, g.testAllProps = h, Modernizr.addTest("flexbox", h("flexBasis", "1px", !0)), Modernizr.addTest("flexboxtweener", h("flexAlign", "end", !0)),
    function () {
      var e, n, t, o, s, i, l;
      for (var a in v)
        if (v.hasOwnProperty(a)) {
          if (e = [], n = v[a], n.name && (e.push(n.name.toLowerCase()), n.options && n.options.aliases && n.options.aliases.length))
    ...
    function (e) {
      ...
      Modernizr._config.enableClasses && (e.length > 0 && (n += " " + t + e.join(" " + t)), w ? x.className.baseVal = n : x.className = n)
