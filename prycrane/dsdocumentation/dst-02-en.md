...
<div class="col-md-2 pull-right">
  <div class="pattern-demo mrgn-tp-lg"> <a class="wb-lbx" title="Theme and topic page" href="#template-01">
      ...
      <div class="container">
        <div class="row"> 
          ...
          <div class="intro col-md-6 col-sm-12 mrgn-bttm-md">
            <h2 property="name" id="wb-cont1">[Theme - Topic title]</h2>
          ...
          <div class="col-md-6 pstn-rght-md pstn-bttm-md hidden-sm hidden-xs"> <img alt="#" src="../dsdocumentation/images/theme-topic-img-825x200.jpg" /> </div>
        ...
        <div class="row">
          <section class="provisional single-feature col-md-8 mrgn-bttm-md mrgn-tp-lg">
            ...
            <figure class="row">
              ...
              <div class="pull-left col-md-6 col-xs-12"> <img src="../dsdocumentation/images/feature-img-360x203.jpg" alt="" class="img-responsive thumbnail mrgn-bttm-sm"> </div>
