...
lang: en
share: True
title: "The Wayfinding Project strives to improve Canada.ca navigation"
description: 
...
<ol>
  ...
  <li><strong>Global footer updates</strong>: menu links will be moved to a main band and a contextual band will be available for specific links related to a page or group of pages.</li>
  <li><strong>Menu button to be retired</strong>: the menu button can be removed when web analytics show that it is used less than 1% of the time.</li>
  <li><strong>Theme page updates</strong>: the theme page template will be updated to help guide people to specific themes by providing straightforward access to top tasks.</li>
</ol>
<p>It seems like a lot of work!  Not to worry.  We are taking a transitional approach to change.   We’ll take small steps to cover a large distance over time, but first let’s have a look at the research that informed our design decisions.</p>
<h2>The Wayfinding Project</h2>
<p>The goal of the Wayfinding Project is to make it easier to adopt the Canada.ca design, make sign-in interactions more obvious, and improve theme navigation.  Our approach is to explore the performance of different designs and follow that up with an assessment of the global navigation with a single-site design.</p>
<h3>2019 Baseline study</h3>
<p>The 2019 Baseline study examined the performance of the Canada.ca design with sites using different designs from four institutions.   This was a moderated, task-based study with 20 participants.   It laid the groundwork for developing a prototype for the comparison study.</p>
<h3>2021 Comparison study</h3>
<p>The 2021 Comparison study of Canada.ca’s global navigation focussed on how users navigate between different top-level pages when using the same site to complete a task.  This was a moderated, task-based study with 18 participants.   Research and prototyping explored options to remove the menu while maintaining or improving the effectiveness of global navigation.  We also wanted to preserve the confidence and trust we’ve established with the Canada.ca site brand.</p>
<p>Our prototype design included the following design elements for testing:</p>
<ul>
...
<div class="panel panel-info col-md-7 mrgn-tp-lg">
  <div class="panel-body">
    <ul class="mrgn-tp-md">
      <li>Canada.ca Wayfinding Research Summary (Coming soon)<br>
        Find more details about our research.</li>
    </ul>
  </div>
</div>
...
<div class="panel panel-info col-md-7 mrgn-tp-lg">
  <div class="panel-body">
    <ul class="mrgn-tp-md">
      <li><a href="https://www.canada.ca/en.html">Canada.ca homepage</a></li>
    </ul>
  </div>
</div>
<div class="clearfix"></div>
