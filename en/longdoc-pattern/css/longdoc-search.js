		     ...
		     success: function (data) {
              ...
              //*******************************************************************
							...
							$.each(data.response.docs, function(i, f) {
								if (f.title_s != header) {
		 							header = f.title_s;
		 							$("#searchResults").append('<p>Results for <strong>' + header.substring(header.indexOf(" - ") + 3, header.lastIndexOf(" - ")) + '</strong></p>');
                ...
                sSnippet = beforeTermSplice + "<strong>" + TermSplice + "</strong>" + afterTermSplice;
                ...
                //bold search term in sSnippet
		 						...
		 						$("#searchResults").append('<li><a href="' + linkAddress + '">' + sSnippet + '</a></li>');
		 					});
